...
class RewardServiceTest {
	...
	@BeforeEach
	void setUp() {
		mockTransactions = Arrays.asList(new Transaction(1L, "CUST1", 120.0, LocalDate.of(2025, 1, 10)),
				new Transaction(2L, "CUST1", 75.0, LocalDate.of(2025, 2, 15)),
				new Transaction(3L, "CUST1", 30.0, LocalDate.of(2025, 3, 5)));
	}

	/**
	 * Tests the {@code calculateRewardPoints} method when transactions exist for
	 * the customer.
	 * 
	 * <p>
	 * Verifies that the reward points are calculated correctly for each month and
	 * in total.
	 * </p>
	 */
	...
	/**
	 * Tests the {@code calculateRewardPoints} method when no transactions exist for
	 * the customer.
	 * 
	 * <p>
	 * Verifies that the reward points and monthly breakdown are empty.
	 * </p>
	 */
