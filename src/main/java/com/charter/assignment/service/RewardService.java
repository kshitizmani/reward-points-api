...
public class RewardService {
	...
	/**
	 * Computes the reward points for each month and the total points for a given
	 * customer.
	 * 
	 * <p>
	 * The calculation is based on transactions made within the last 3 months.
	 ...
	 * @return a {@code RewardResponseDto} containing monthly and total reward
	 *         points.
	 */
